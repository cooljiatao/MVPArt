...
public class WelfareItemHolder extends BaseHolder<PhotoWelfareInfo> {
    ...
    @Override
    public void setData(PhotoWelfareInfo data, int position) {

        mName.setText(data.getCreatedAt());
